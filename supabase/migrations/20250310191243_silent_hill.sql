...
-- Otomatik timestamp güncellemesi için fonksiyon
DO $$ BEGIN
...
DROP TRIGGER IF EXISTS update_milk_sessions_updated_at ON milk_sessions;
...
DROP TRIGGER IF EXISTS update_milk_tanks_updated_at ON milk_tanks;
...
DROP TRIGGER IF EXISTS update_session_total_milk_trigger ON milk_records;
