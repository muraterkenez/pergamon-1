...
DROP POLICY IF EXISTS "Authenticated users can view stock items" ON stock_items;
DROP POLICY IF EXISTS "Authenticated users can insert stock items" ON stock_items;
DROP POLICY IF EXISTS "Authenticated users can update stock items" ON stock_items;
DROP POLICY IF EXISTS "Authenticated users can delete stock items" ON stock_items;
