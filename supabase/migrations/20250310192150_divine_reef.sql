/*
  # Süt Sağım Seansları Şeması

  1. Yeni Tablolar
    - milk_sessions: Sağım seansları
      - id: UUID, birincil anahtar
      - session_date: Sağım tarihi
      - session_type: Sağım zamanı (sabah/akşam)
      - start_time: Başlangıç zamanı
      - end_time: Bitiş zamanı
      - milker_id: Sağımcı ID (auth.users tablosuna referans)
      - total_milk: Toplam süt miktarı
      - temperature: Süt sıcaklığı
      - notes: Notlar

    - milk_records: Hayvan bazında süt kayıtları
      - id: UUID, birincil anahtar
      - session_id: Sağım seansı ID'si
      - animal_id: Hayvan ID'si
      - quantity: Süt miktarı
      - fat_content: Yağ oranı
      - protein_content: Protein oranı
      - temperature: Süt sıcaklığı
      - notes: Notlar
    ...
    - milk_quality_tests: Süt kalite testleri
      ...
      - fat_content: Yağ oranı
      - protein_content: Protein oranı
      - lactose_content: Laktoz oranı
      - somatic_cell_count: Somatik hücre sayısı
      - bacterial_count: Bakteri sayısı
      - antibiotics_test: Antibiyotik testi sonucu
    ...
    - milk_tanks: Süt tankları
      ...
      - temperature: Sıcaklık
      - last_collection_date: Son toplama tarihi
      - next_collection_date: Sonraki toplama tarihi
      - status: Durum (aktif/bakımda/devre dışı)
      - notes: Notlar
